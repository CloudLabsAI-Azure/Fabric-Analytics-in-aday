...
서문	3<br>
데이터 흐름 2 세대	3<br>
작업 1: Snowflake 쿼리를 데이터 흐름에 복사	3<br>
작업 2: Snowflake 에 대한 연결 만들기	5<br>
작업 3: Supplier 및 PO 쿼리를 위한 데이터 대상 구성	6<br>
작업 4: Snowflake 데이터 흐름 이름 바꾸기 및 게시	9<br>
작업 5: Dataverse 쿼리를 데이터 흐름에 복사	10<br>
작업 6: Dataverse 에 대한 연결 만들기	11<br>
작업 7: Customer 쿼리를 위한 데이터 대상 만들기	12<br>
작업 8: Dataverse 데이터 흐름 이름 바꾸기 및 게시	14<br>
작업 9: SharePoint 쿼리를 데이터 흐름에 복사	16<br>
작업 10: SharePoint 연결 만들기	18<br>
작업 11: People 쿼리를 위한 데이터 대상 구성	19<br>
작업 12: SharePoint 데이터 흐름 이름 바꾸기 및 게시	21<br>
참조	24<br>
...
7.	**브라우저**로 돌아갑니다.
8.	**데이터 흐름 창에**서 **중앙 창**을 선택하고 **Ctrl+V**을 입력합니다(현재 마우스 우클릭 붙여넣기는 지원되지 않습니다). MAC 디자이스를 사용하는 경우 Cmd+V를 사용하여 붙여넣습니다.<br>
...
7.	마찬가지로 **PO** 쿼리를 마우스 우클릭합니다. **스테이징 사용**을 선택하여 확인 표시를 제거합니다.<br>
...
7.	**데이터 흐름 창**에서 **Ctrl+V**를 입력합니다(현재 마우스 우클릭 붙여넣기는 지원되지 않습니다). MAC 디자이스를 사용하는 경우 Cmd+V를 사용하여 붙여넣습니다.<br>
**참고:** 랩 환경에서 작업하는 경우 화면 오른쪽 상단에 있는 줄임표를 선택합니다. 슬라이더를 사용하여 **VM 네이티브 클립보드**를 **활성화**합니다. 대화 상자에서 확인을 선택합니다. 쿼리 붙여넣기가 완료되면 이 옵션을 비활성화할 수 있습니다.
...
**Customer** 쿼리를 **마우스 우클릭**하고 **스테이징 사용**을 선택하여 확인 표시를 제거합니다.
...
7.	**데이터 흐름 창**에서 **Ctrl+V**를 입력합니다(현재 마우스 우클릭 붙여넣기는 지원되지 않습니다).<br>
**참고:** 랩 환경에서 작업하는 경우 화면 오른쪽 상단에 있는 줄임표를 선택합니다. 슬라이더를 사용하여 **VM 네이티브 클립보드**를 **활성화**합니다. 대화 상자에서 확인을 선택합니다. 쿼리 붙여넣기가 완료되면 이 옵션을 비활성화할 수 있습니다.<br>
...
1.	앞서 언급했듯이 우리는 이 데이터를 스테이징하지 않습니다. 따라서 쿼리 창에 있는
**People** 쿼리를 **마우스 우클릭**하고 **스테이징 사용**을 선택하여 확인 표시를 제거합니다.
