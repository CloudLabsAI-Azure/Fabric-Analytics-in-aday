...
b.	Recommended: esta seção fornece acesso à documentação de aprendizagem de início rápido.
...
2.	Selecione Data Engineering. Você será direcionado para a Página Inicial do Data Engineering. Novamente, a página contém três seções principais. Na seção New, observe os itens:
...
2.	Selecione Data Science. Você será direcionado para a Página Inicial do Data Science. Novamente, existem três seções. Na seção New, observe os itens:
...
e.	Import notebook: usado para importar notebooks da máquina local.
...
b.	Banco de Dados KQL: usado para carregar rapidamente dados e armazenar dados estruturados, não estruturados e de streaming para consulta.
c.	Conjunto de Consultas KQL: usado para executar consultas nos dados para produzir tabelas e visuais compartilháveis.
...
•	Veja a postagem do blog para ler o anúncio completo de GA do Microsof t Fabric
•	Explore o Fabric por meio do Tour Guiado
•	Inscreva-se para a avaliação gratuita do Microsof t Fabric
•	Visite o site do Microsof t Fabric
...
•	Blog de integração do Dataverse e Microsof t Fabric
