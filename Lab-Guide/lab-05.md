...
8.	In Connessione gateway espandere **Credenziali dell'origine dati**. Viene visualizzato un elenco delle connessioni usate nel flusso di dati. In questo caso, Lakehouse e ADLS.<br>
      a.	**Lakehouse**: questa è la connessione per importare dati dal flusso di dati.<br>
      b.	**ADLS**: questa è la connessione ai dati dell'origine ADLS.<br>
