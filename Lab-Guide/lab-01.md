...
8.	Otteniamo i dettagli del prodotto per gruppo di prodotti e rivenditore. Nel grafico a barre Vendite per gruppo di prodotti e azienda rivenditrice fare clic con il pulsante destro del mouse sulla barra Packaging Materials per Tailspin Toys e nella finestra di dialogo selezionare Drill-through -> Product Detail.
