...
5.	Espandere la matrice per visualizzare i dati come una matrice.

6.	Selezionare Salva - > Salva come report in alto a destra della schermata.

7.	Si apre la finestra di dialogo Salva report. Digitare Unità per fornitore nella casella di testo
...
5.	Si apre la finestra di dialogo Merge. Nel menu a discesa Tabella destra per l'unione selezionare
Product.
...
14.	Si apre la finestra di dialogo Merge. Nel menu a discesa Tabella destra per l'unione selezionare
Supplier.
...
10.	Si apre la finestra di dialogo Nuova relazione. Assicurarsi che la Tabella 1 sia Sales e che la
...
15.	Analogamente, creare una relazione molti-a-uno tra le tabelle Sales e Product. Selezionare
...
12.	Con la tabella Sales selezionata nel menu in alto, selezionare Home -> Nuova misura. Notare che viene visualizzata la barra della formula.
13.	Immettere Orders = DISTINCTCOUNT(Sales[InvoiceID]) nella barra della formula.
14.	Fare clic sul segno di spunta a sinistra della barra della formula o premere il tasto INVIO.
15.	Nel pannello Proprietà a destra espandere la sezione Formattazione.
16.	Nel menu a discesa Formato selezionare Numero intero.
...
3.	Si apre la finestra di dialogo Nuova relazione. Assicurarsi che la Tabella 1 sia Product e che la
...
6.	Assicurarsi che il campo Direzione filtro incrociato sia impostato su Entrambi.
7.	Selezionare OK.

 
8.	Allo stesso modo, creare una relazione molti-a-uno con Direzione filtro incrociato impostato su
Entrambi tra Product_Details e Product. Selezionare StockItemID da Product_Details e
StockItemID da Product.
9.	Creiamo ora una relazione tra Reseller e Geo. Selezionare PostalCityID dalla tabella Reseller e trascinarlo su CityID nella tabella Geo.
10.	Si apre la finestra di dialogo Nuova relazione. Assicurarsi che la Tabella 1 sia Reseller e che la
Colonna sia PostalCityID.
11.	Assicurarsi che la Tabella 2 sia Geo e che la Colonna sia CityID.
12.	Assicurarsi che il campo Cardinalità sia impostato su Molti a uno (*:1).
13.	Assicurarsi che il campo Direzione filtro incrociato sia impostato su Entrambi.
14.	Selezionare OK.

15.	Creiamo ora una relazione tra Customer e Reseller. Selezionare ResellerID dalla tabella Customer
e trascinarlo su ResellerID nella tabella Reseller.
16.	Si apre la finestra di dialogo Nuova relazione. Assicurarsi che la Tabella 1 sia Customer e che la
Colonna sia ResellerID.
17.	Assicurarsi che la Tabella 2 sia Reseller e che la Colonna sia ResellerID.
...
6.	Seguire passaggi analoghi per aggiungere le seguenti misure:
