...
Attività 1 - Copia di query di Snowflake nel flusso di dati	3
Attività 2 - Creazione della connessione a Snowflake	5
Attività 3 - Configurazione della destinazione dei dati per le query Supplier e PO	6
Attività 4 - Ridenominazione e pubblicazione del flusso di dati Snowflake	9
Attività 5 - Copia di query Dataverse nel flusso di dati	10
Attività 6 - Creazione della connessione a Dataverse	11
Attività 7 - Creazione della destinazione dati per la query Customer	12
Attività 8 - Pubblicazione e ridenominazione del flusso di dati Dataverse	15
Attività 9 - Copia di query SharePoint nel flusso di dati	16
Attività 10 - Creazione della connessione a SharePoint	18
Attività 11 - Configurazione della destinazione dei dati per la query People	19
Attività 12 - Pubblicazione e ridenominazione del flusso di dati SharePoint	21
Riferimenti	23

 
Introduzione
Nel nostro scenario, i dati sui fornitori si trovano in Snowflake, i dati sui clienti si trovano in Dataverse e i dati sui dipendenti si trovano in SharePoint. Tutte queste origini dati vengono aggiornate in
momenti diversi. Per ridurre al minimo il numero di aggiornamenti dei dati dei flussi di dati, creeremo flussi di dati individuali per ciascuna di queste origini dati.
...
dell'ambiente lab.
4.	Nella barra multifunzione selezionare Home -> Trasforma dati. Si apre la finestra Power Query.
...
2.	Si apre la finestra di dialogo Connetti a origine dati. Assicurarsi che nel menu a discesa
Connessione sia selezionato Crea nuova connessione.
...
Viene stabilita la connessione ed è possibile visualizzare i dati nel pannello di anteprima. Esplorare i Passaggi applicati delle query. In genere, la query Suppliers contiene i dettagli sui fornitori e
SupplierCategories contiene le categorie di fornitori. Queste due tabelle vengono unite per creare la dimensione Supplier, con le colonne necessarie. Analogamente, PO Line Items viene unita con PO per creare il fatto PO. Ora dobbiamo inserire i dati di Supplier e PO in Lakehouse.
6.	Come indicato in precedenza, non effettuiamo lo staging di questi dati. Quindi fare clic con il
pulsante destro del mouse sulla query Supplier nel riquadro Query e selezionare Abilita staging
...
3.	Si apre la finestra di dialogo Connetti alla destinazione dati. Nel menu a discesa Connessione
...
6.	Vogliamo creare la tabella nel Lakehouse creato in precedenza. Nel pannello di sinistra andare a
...
10.	Questa volta useremo le impostazioni automatiche perché i dati verranno aggiornati
completamente. Inoltre, le colonne verranno rinominate secondo necessità. Selezionare
Salva impostazioni.
...
Viene stabilita la connessione ed è possibile visualizzare i dati nel pannello di anteprima. Esplorare i Passaggi applicati delle query. I dati sui clienti sono disponibili per categoria: BabyBoomer, GenX,
GenY e GenZ. Queste quattro query vengono aggiunte per creare la query Customer. Ora dobbiamo inserire i dati di Customer in Lakehouse.
...
4.	Si apre la finestra di dialogo Connetti alla destinazione dati. Nel menu a discesa Connessione
selezionare Lakehouse (nessuno).
...
7.	Vogliamo creare la tabella nel Lakehouse creato in precedenza. Nel pannello di sinistra andare a
Lakehouse -> FAIAD_<nomeutente>
...
4.	Si apre la finestra di dialogo Proprietà flusso di dati. Cambiarne il Nome in
...
2.	Se non lo si è ancora aperto, aprire il file FAIAD.pbix contenuto nella cartella C:\FAIAD\Reports
dell'ambiente lab.
...
pulsante destro del mouse sulla query People nel riquadro Query e selezionare Abilita staging
per rimuovere il segno di spunta.
...
11.	Questa volta useremo le impostazioni automatiche perché i dati verranno aggiornati
completamente. Inoltre, le colonne verranno rinominate secondo necessità. Selezionare
Salva impostazioni.
