...
3.	Si apre la finestra di dialogo Connetti a origine dati. Assicurarsi che nel menu a discesa
Connessione sia selezionato Crea nuova connessione.
4.	Il Tipo di autenticazione dovrebbe essere impostato su Snowflake.
