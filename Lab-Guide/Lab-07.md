...
작업 3: 보고서에 헤더 추가	10
작업 4: 보고서에 KPI 추가	11
작업 5: 보고서에 꺾은선형 차트 추가	14
작업 6: 보고서 저장	15
작업 7: Date 테이블의 Year 열 구성	15
작업 8: Date 테이블의 Short_Month_Name 열 구성	17
작업 9: 꺾은선형 차트 형식 지정	19
작업 10: Direct Lake 모드를 시뮬레이션하기 위해 새 데이터 추가	21
랩 환경 정리	25
참조	26
...
8.	Power BI가 보고서 자동 만들기를 시작합니다. 원할 경우 데이터를 사전 선택하는 옵션도 있습니다. 보고서가 준비되면 화면 오른쪽 상단에 대화 상자가 나타납니다. View report now를 선택합니다.
...
4.	보고서에서 사용할 의미 체계 모델을 선택하면 대화 상자가 열립니다. lh_FAIAD를 선택합니다.
