...
Introduzione	3
Power BI	3
Attività 1 - Creazione automatica del report	3
Attività 2 - Configurazione dello sfondo per un nuovo report	7
Attività 3 - Aggiunta dell'intestazione al report	9
Attività 4 - Aggiunta di KPI al report	10
Attività 5 - Aggiunta di un grafico a linee al report	13
Attività 6 - Salvataggio del report	14
Attività 7 - Configurazione della colonna Year nella tabella Date	14
Attività 8 - Configurazione della colonna Short_Month_Name nella tabella Date	15
Attività 9 – Formattazione del grafico a linee	17
Attività 10 - Aggiunta di nuovi dati per simulare la modalità Direct Lake	19
Pulizia dell'ambiente lab	23
Riferimenti	24
...
8.	Power BI avvierà la creazione automatica del report. Si noti la presenza di un'opzione per preselezionare i dati, se lo desideriamo. Quando il report è pronto, in alto a destra della schermata si apre una finestra di dialogo. Selezionare View report now.
...
16.	Aggiungiamo un altro indicatore KPI. Selezionare la scheda con più righe Sales appena creata.
...
10.	Nel riquadro Proprietà a destra espandere la sezione Avanzate.
11.	Nell'elenco a discesa Ordina per colonna selezionare Month.

12.	Tornare al report selezionando rpt_Sales_Report nella barra dei menu a sinistra.
13.	Selezionare Modifica dal menu in alto.
14.	Nel menu in alto selezionare Aggiorna. Si noti che i mesi sono ordinati correttamente.
...
15.	Per salvare il report, nel menu selezionare File -> Salva.
...
10.	Nella barra multifunzione selezionare Home -> Accoda query.
11.	Si apre la finestra di dialogo Accoda. Nel menu a discesa Tabella da accodare selezionare
MayInvoice.
 
12.	Selezionare OK.

13.	Selezionare Pubblica nell'angolo inferiore destro per salvare e pubblicare gli aggiornamenti.
