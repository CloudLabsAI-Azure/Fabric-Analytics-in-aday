...
5.	Mettez en surbrillance **État Sales** et définissez les champs **Police** sur **Segoe UI** et **Taille de la police** sur
**14**.
...
le moteur Power BI, prêtes à l’analyse. Explorons cela.

Dans un scénario réel, les données sont mises à jour à la source. Puisque nous sommes dans un
environnement de formation, nous allons simuler cela en le connectant à un fichier Parquet avec les données de mai 2023.
